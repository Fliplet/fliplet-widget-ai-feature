...
CRITICAL: As a selectors always use the .ai-feature-guid-${componentGuid} (already exists in the html by default) as a parent selector to ensure the code is specific to the component.
